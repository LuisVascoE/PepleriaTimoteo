    ...
    <div class="jumbotron jumbotron-fluid ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./img/borrador.jpg" class="d-block w-30 rounded mx-auto d-lg-block mi-img-carrusel" alt="borrador">
          </div>
          <div class="carousel-item">
            <img src="./img/cuerdernos.jpg" class="d-block w-30 rounded mx-auto d-lg-block mi-img-carrusel" alt="cuerderno">
          </div>
          <div class="carousel-item">
            <img src="./img/Lapiceros.jpg" class="d-block w-25 rounded mx-auto d-lg-block mi-img-carrusel" alt="Lapiceros">
          </div>
          <div class="carousel-item">
            <img src="./img/morral-para-portatil-xtb-220-15-6-xtech-durham-azul-798302230866.jpg" class="d-block w-25 rounded mx-auto d-lg-block mi-img-carrusel" alt="morral">
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p>
                    <h3 class="correcto"><img src="/img/correcto.png"  alt="correcto"></h3>
            ...
            <div class="col-sm-3">
                <p>
                    <h3 class="envio-paquetes"><img src="/img/entrega-de-paquetes.png"  alt="envio-paquetes"></h3>
            ...
            <div class="col-sm-3">
                <p>
                    <h3 class="mio-pago"><img src="/img/devolucion-de-dinero.png"  alt="mio-pago"></h3>
            ...
            <div class="col-sm-3">
                <p>
                    <h3 class="mio-proteccion"><img src="/img/proteger.png"  alt="mio-proteccion"></h3>
